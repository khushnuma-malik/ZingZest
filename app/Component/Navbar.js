  ...
  return (
    <div className='flex flex-col md:flex-row md:justify-start justify-between items-center  py-2 shadow-xl'>
      <div className='logo mx-5'>
        <Link href={'/'}><Image width={100} height={40} src="/logo.jpg.png" alt="" /></Link>
      </div>
      <div className='nav'>
      ...
      <div ref={ref} className='w-72 h-full  sidebar absolute top-0 right-0 bg-pink-200 px-8 py-10 transition-transform translate-x-full'>
        ...
        <button class="flex mx-auto mt-16 text-white bg-pink-500 border-0 py-2 px-5 focus:outline-none hover:bg-pink-600 rounded text-sm"><IoBagCheckOutline className='m-1' />
          Checkout</button>
      </div>
